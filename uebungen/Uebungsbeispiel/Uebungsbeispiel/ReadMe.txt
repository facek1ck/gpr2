========================================================================
    KONSOLENANWENDUNG: Uebungsbeispiel-Projektübersicht
========================================================================

Diese Uebungsbeispiel-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Uebungsbeispiel-Anwendung besteht.


Uebungsbeispiel.vcxproj
...
Uebungsbeispiel.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Uebungsbeispiel.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
